...
|---|---|---|---|---|
| **3.1** | Controlador de Healthcheck | Backend / API | `api/app/Http/Controllers/Api/V1/HealthCheckController.php` | ⏳ Pendiente |
| **3.2** | Workflow de CI (Integración Continua) | GitHub Actions | `.github/workflows/ci.yml` | ⏳ Pendiente |
| **3.3** | Script de Respaldo PostgreSQL | DevOps / Scripts | `scripts/backup_db.bat` / `scripts/backup_db.sh` | ⏳ Pendiente |
